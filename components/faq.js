          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 p-4 text-sm">
              ...
              <div className="my-2">
                ...
                Praesent id eros tortor. Nunc faucibus mollis tortor, sed
                bibendum urna volutpat ut. Aenean dapibus, nunc vel feugiat
                laoreet, risus arcu pulvinar enim, sed euismod odio dui eu
                ipsum. Vestibulum elementum rutrum urna, in posuere ante
                ullamcorper ac
              </div>
            </div>
              ...
              <div className="p-4">
                <div className="mb-2">
                  <div className="font-medium rounded-sm text-lg px-2 py-3 flex text-gray-800 flex-row-reverse mt-2 cursor-pointer text-black bg-white hover:bg-white">
                    <div className="flex-auto">WHAT ARE REAL MONSTERS</div>
                ...
                <div className="mb-2">
                  <div className="font-medium rounded-sm text-lg px-2 py-3 flex text-gray-800 flex-row-reverse mt-2 cursor-pointer text-black bg-white hover:bg-white">
                    <div className="flex-auto">
                      HOW MUCH DOES 1 REAL MONSTER NFT COST
                    </div>
                    <div className="px-2 mt-1">
                      <div>
                        <svg
                ...
                <div className="mb-2">
                  <div className="font-medium rounded-sm text-lg px-2 py-3 flex text-gray-800 flex-row-reverse mt-2 cursor-pointer text-black bg-white hover:bg-white">
                    <div className="flex-auto">
                      WHAT IS THE RELEASE DATE FOR REAL MONSTERS
                    </div>
                    <div className="px-2 mt-1">
                      <div>
                        <svg
