      ...
      <div className="flex w-1/2 py-2">
        <div className="py-3 sm:max-w-xl sm:mx-auto w-full px-2 sm:px-0">
          <div className="relative text-gray-700 antialiased text-sm font-semibold">
            ...
            <div className="hidden sm:block w-1 bg-rm_green absolute h-full left-1/2 transform -translate-x-1/2"></div>
              ...
              <div className="flex flex-col sm:flex-row items-center">
                <div className="flex justify-start w-full mx-auto items-center">
                  <div className="w-full sm:w-1/2 sm:pr-8">
                    <div className="p-4 bg-white rounded shadow font-Thasadith">
                      when the project sells out 10% message
                    </div>
                  </div>
                </div>
                <div className="rounded-full bg-rm_green border-white border-2 p-2 w-12 h-12 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center -mt-4 md:mt-0">
